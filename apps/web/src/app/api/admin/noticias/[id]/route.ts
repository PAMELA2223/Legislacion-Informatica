...
import { EliminarNoticiaUseCase, GuardarNoticiaUseCase } from "@/modules/admin/application/admin.use-cases";
...
export async function PUT(
  ...
  try {
    ...
    const useCase = new GuardarNoticiaUseCase(repo);
...
export async function DELETE(
  ...
  const repo = new PrismaAdminRepository(prisma);
  const useCase = new EliminarNoticiaUseCase(repo);
