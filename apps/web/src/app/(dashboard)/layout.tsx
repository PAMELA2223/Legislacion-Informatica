...
// Bloquea aquí, en un solo lugar, a quien no tiene
// sesión y a INVITADO (que no tiene acceso a ninguna sección interna,
// solo a las páginas públicas fuera de este grupo de rutas). La
// subárea (/admin) además aplica su propio layout con una
